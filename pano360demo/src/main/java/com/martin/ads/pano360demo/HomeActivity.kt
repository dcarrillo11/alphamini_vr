...
class HomeActivity : AppCompatActivity() {
	...
	fun HomeContent() {
		...
		Column {
			CardView(Icons.Default.AddBox, R.string.title_7, R.string.content_text_7) {
				start(
					"""android.resource://$packageName/${R.raw.comienzo_detalle_vr}""",
					MimeType.RAW or MimeType.VIDEO,
				)
			}
			CardView(Icons.Default.ArrowRight, R.string.title_8, R.string.content_text_8) {
				start(
					"""android.resource://$packageName/${R.raw.right_vr_injected}""",
					MimeType.RAW or MimeType.VIDEO,
				)
			}
			CardView(Icons.Default.ArrowLeft, R.string.title_9, R.string.content_text_9) {
				start(
					"""android.resource://$packageName/${R.raw.left_vr}""",
					MimeType.RAW or MimeType.VIDEO,
				)
			}
			CardView(Icons.Default.SwitchRight, R.string.title_10, R.string.content_text_10) {
				start(
					"""android.resource://$packageName/${R.raw.side_both}""",
					MimeType.RAW or MimeType.VIDEO,
				)
			}
			CardView(Icons.Default.CheckBox, R.string.title_11, R.string.content_text_11) {
				start(
					"""android.resource://$packageName/${R.raw.fin_vr}""",
					MimeType.RAW or MimeType.VIDEO,
				)
			}
			...
			CardView(Icons.Default.VideoLibrary, R.string.title_2, R.string.content_text_2) {
